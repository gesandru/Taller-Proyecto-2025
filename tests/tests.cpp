...
Matrix P = zeros(6,6);
	...
	Matrix B(6,6);
	B(1,1) = 100030051.289634; B(1,2) =  1416.64688492363; B(1,3) = 38.3247592060704; B(1,4) = 6010.60735344927; B(1,5) = 282.819148824426; B(1,6) = 6.44230434596996;
	...
	B(4,1) = 6010.60735344927; B(4,2) =  282.819193072307; B(4,3) = 6.44240187111654; B(4,4) = 1000.06154267741; B(4,5) = 0.0156154526297801; B(4,6) = 0.000295093092376877;
	...
	B(6,1) = 6.44230434596996; B(6,2) =  1.18545645495969; B(6,3) = 4468.07063235661; B(6,4) = 0.000295093092376877; B(6,5) = 5.41618162396946e-05; B(6,6) = 999.976237491234;
	
	TimeUpdate(P, Phi, 0);
	
    _assert(m_equals(P, B, 1e-10));
